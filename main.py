...
# This allows Krisha's React frontend (on a different port) to call your API
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
def root():
    return {"message": "GrievanceAI backend is running"}
...
# ── THE MAIN ENDPOINT — all 5 agents run here ──────────────────
